...
urlpatterns = [
    ...
    # path('restfeedback',restfeedback.as_view(),name='restfeedback'),
    path('Resreview/reply/<int:reply_id>/', Resreview.as_view(), name='reply_Resreview'),
    # ///////////////ROOM////////////////////////
    ...
    path('Review/reply/<int:reply_id>/', Review.as_view(), name='reply_Review'),
    ...
    path('viewrestaurant',Viewrestaurant1.as_view(),name='viewrestaurant'),
    ...
    path('place_food_order1/<int:id>',PlaceFoodOrderView1.as_view(), name='place_food_order1'),
    path('room-rating-feedback/', RoomRatingFeedbackAPIView.as_view(), name='room-rating-feedback'),
    path('food-rating-feedback/', FoodRatingFeedbackAPIView.as_view(), name='food-rating-feedback'),
    path('view-profile/<int:login_id>/', ViewProfileAPIView.as_view(), name='view-profile'),
